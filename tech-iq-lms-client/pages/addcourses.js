            ...
            >
                <div className="addFormContainer">
                    ...
                    <div className="addFormItems">
                        ...
                        <select id="departments" onChange={(e) => setDepartment(e.target.value)} >
                            <option value="Computer Science">Computer Science</option>
                            <option value="Electrical Engineering">Electrical Engineering</option>
                            <option value="Computer Engineering">Computer Engineering</option>
                            <option value="Network Management Technology">Network Management Technology</option>
                    ...
                    <div className="addFormItems">
                        ...
                        <input id="number" onChange={(e) => setCourse_Number(e.target.value)}></input>
                    </div>
                    <div className="addFormItems">
                        <label className="addCoursesLabel" for="name">Course name: </label>
                        <input id="name" onChange={(e) => setCourse_Name(e.target.value)}></input>
                    </div>
                    <div className="addFormItems">
                        <input className="addCoursesLabel" type="checkbox" id="Monday" onChange={() => {setDays([...days,'Monday'])}}></input>
                        <label className="addCoursesLabel" for="Monday">Monday</label>
                    </div>
                    <div className="addFormItems">
                        <input className="addCoursesLabel" type="checkbox" id="Tuesday"onChange={() => {setDays([...days,'T'])}} ></input>
                    ...
                    <div className="addFormItems">
                        ...
                        <input className="addCoursesLabel" type="time" id="stTime" name="stTime" onChange={(e) => setStart_Time(e.target.value)}></input>
                    </div>
                    <div className="addFormItems">
                        <label className="addCoursesLabel" for="edTime" > End Time: </label>
                        <input className="addCoursesLabel" type="time" id="edTime" name="edTime" onChange={(e) => setEnd_Time(e.target.value)}></input>
                    </div> 
                    <div className="addFormItems">
                        <label className="addCoursesLabel" for="location" > Location </label>
                        <input className="addCoursesLabel" type="location" id="stTime" name="stTime" onChange={(e) => setLocation(e.target.value)}></input>
                    </div> 
                    <div className="addFormItems">
                        <label className="addCoursesLabel" for="capacity">Max. capacity</label>
                        <input id="capacity" onChange={(e) => setMax_Capacity(e.target.value)}></input>
                    </div> 
                    {blankfields === true ? (
                        <div className="missingFields">Missing required fields</div>
                    ) : null}   
                    <div className="addButtonItem">
                        <button className="courseButton" type="submit" value="Create">Create</button>
